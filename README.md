...
The projects are focused on data analysis, predictive modeling, and decision-making optimization:
...
1.  **Clone the repository:**
    ```bash
    git clone https://github.com/FreyFlyy/python-projects.git
    ```
2.  **Install dependencies:** (Use of a virtual environment is recommended)
    ```bash
    pip install -r requirements.txt
    ```
    *(Note: individual `requirements.txt` files are located within each project folder).*
